            ...
            while (true) {
                ...
                do {
                    if (!_$_$2edwb$) {
                        ...
                        _$$f_dwquig11__.setIconImage(new javax.swing.ImageIcon((Objects.requireNonNull(KeyGen.class.getClassLoader().getResource("icoImg.png"),""))).getImage());
                        ...
                        fixME.setIcon(new javax.swing.ImageIcon((Objects.requireNonNull(KeyGen.class.getClassLoader().getResource("fix.png")))));
